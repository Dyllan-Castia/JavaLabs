...
public class Database {
    ...
    public void mergeSort() {
        ...
        for (int size = 1; size < n; size = 2 * size) {
           ...
           /* TODO 7: Stop the for loop when all sub arrays have been
                   processed. */
            for (int leftStart = 0; leftStart < n; leftStart = leftStart + 2 * size) {
                ...
                int leftEndExcluded = rightStart;
                ...
                ArrayList<Registration> leftArray =
                        new ArrayList<>(registrations.subList(leftStart, leftEndExcluded));

                ArrayList<Registration> rightArray =
                    new ArrayList<>(registrations.subList(rightStart, rightEndExcluded));
    ...
    private void merge(
        ...
        while (leftIndex < leftArray.size()
            ...
            Registration leftVal = leftArray.get(leftIndex);
            Registration rightVal = rightArray.get(rightIndex);
