...
public class SinglyLinkedPlaylistManager {
    ...
    public void addFavoriteSong(Song newSong) {
        ...
        while (temp != null) {
            if (current.song.getTitle().equalsIgnoreCase(newSong.getTitle())) {
        ...
        else { // TODO 4: if not empty, find the last node in the list
            Node last = head;
    ...
    public void removeFavoriteSong(int index) {
        ...
        if (index == 1) {
            ...
            head = head.next;
            System.out.println(removedSong.getTitle() + " removed from playlist.");
            return;
        }
        ...
        Song removedSong = currentNode.song;
    ...
    public void displayFavoriteSongs() {
        ...
        while (currentHead != null) {
            System.out.println("Current index: " + index + " Song: " + current.song);
