...
public class SeatBooking {
    ...
    public void cancelBooking(String seatNumber) {
        ...
        System.out.println("No booking for seat number " + seatNumber + " was found.");
    }
    ...
    public void updateBooking(String oldSeatNumber, String newSeatNumber) {
        ...
        for (Seat seat : bookedSeatsList) {
            if (seat.getSeatNumber().equals(oldSeatNumber) && !seat.isCanceled()) {
                ...
                for (Seat innerSeat : bookedSeatsList) {
                    if (innerSeat.getSeatNumber().equals(newSeatNumber) && innerSeat.isBooked() && !innerSeat.isCanceled()) {
                        System.out.println("New seat is already booked.");
                    }
                }
                System.out.println("Seat " + oldSeatNumber + " updated to " + newSeatNumber);
            }
            else {
                System.out.println("No booking was found for seat " + oldSeatNumber);
            }
        }
    }
    ...
    public void displayBookings() {
        ...
        if (bookedSeatsList.isEmpty()) {
            ...
            for (Seat seat : bookedSeatsList) {
                if (seat.isBooked() && !seat.isCanceled()) {
                    System.out.println("Seat #" + seat.getSeatNumber() + " booked for " + seat.getBookingDate());
                }
            }
        }
