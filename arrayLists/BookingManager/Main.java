        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    bookingManager.addNewBooking(seatNum);
                    break;
                case 2:
                    // TODO 17: remove Booking
                    String seatToCancel;
                    // print a message instructing the user to enter the seat number they wish to cancel.
                    System.out.print("Enter the seat number you wish to cancel: ");
                    // take the seat number input from the user.
                    seatToCancel = keyboard.nextLine();
