...
public class DirectoryManager {
    ...
    public static void createDirectory(String directoryPath) {
        ...
        if (!directory.exists()) {
            ...
            System.out.println("Directory: " + directory.getName() + " already exists.");
        }
    }
    ...
    public static void renameDirectory(String currentDirectory, String newDirectory) {
        ...
        if (newDir.exists()) {
            System.err.println("Directory already exists, cannot rename to that name.");
            return;
        }
