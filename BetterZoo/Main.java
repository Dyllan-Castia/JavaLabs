...
public class Main {
    ...
    public static void readObjectsFromFile() {
        Tiger desTiger = null;
        Penguin desPenguin = null;
        Dolphin desDolphin = null;

        try (FileInputStream tIn = new FileInputStream("tiger.txt");
        ObjectInputStream tigerIn = new ObjectInputStream(tIn)) {
            desTiger = (Tiger) tigerIn.readObject();
            System.out.println("Tiger loaded.");
            System.out.println(desTiger.toString());
        } catch (IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }

        try (FileInputStream pIn = new FileInputStream("penguin.txt");
             ObjectInputStream penguinIn = new ObjectInputStream(pIn)) {
            desPenguin = (Penguin) penguinIn.readObject();
            System.out.println("Penguin loaded.");
            System.out.println(desPenguin.toString());
        } catch (IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }

        try (FileInputStream dIn = new FileInputStream("dolphin.txt");
             ObjectInputStream dolphinIn = new ObjectInputStream(dIn)) {
            desDolphin = (Dolphin) dolphinIn.readObject();
            System.out.println("Dolphin loaded.");
            System.out.println(desDolphin.toString());
        } catch (IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }
    }
